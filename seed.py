...
user1 = User(id = 1, username = 'jsmith', firstname = 'John', lastname = 'Smith')
user2 = User(id = 2, username = 'jstaten', firstname = 'Jason', lastname = 'Staten')

product1 = Product(productname = 'Ralph Lauren Duffle Bag',
                    productdescription = 'A beautiful Ralph Lauren Duffle Bag in great condition', user_id = 1)
